...
- `DIGEST_SCHEDULE_HOUR_AM` (default 0), `DIGEST_SCHEDULE_HOUR_PM` (default 24), `DIGEST_CHECK_INTERVAL_MINUTES` (default 60) — latest-news trickle runs around the clock; narrow the window to restrict hours
- `DIGEST_MAX_STORIES` (default 5) — max individual stories per trickle run
